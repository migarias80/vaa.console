...
class CheckService implements ICheckService
{
    ...
    function checkArchivosDepartamentos($idEmpresa) {
        ...
        foreach ($departamentos as $departamento) {
			...
			// $file = utf8_decode($directorio . "\\" . $nombreArchivo);
			$file = iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $directorio . "\\" . $nombreArchivo);
            if (!file_exists($file)) {
    ...
    function checkArchivosPersonas($idEmpresa) {
        ...
        foreach ($personas as $persona) {
            ...
            if ($persona->getPhbSecId() != null) {
				...
				$file2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $directorio . "\\" . $nombreArchivoSec);
