...
class PersonaMinDTO implements IGenericDTO
{
    private $phb_id;
    private $phb_dep_id;
    ...
    function __construct($data = null)
    {
        ...
        if (is_array($data)) {
        ...
        } else if ($data instanceof PersonaMin) {
            ...
            $this->phb_full_name = trim($data->getPhbLastName1() . " " . $data->getPhbLastName2() . ", " . $data->getPhbFirstName() . " " . $data->getPhbMiddleName());
        }
    ...
    /**
     * @param string $phb_full_name
     */
    public function setPhbFullName($phb_full_name)
    {
        $this->phb_full_name = $phb_full_name;
    }
